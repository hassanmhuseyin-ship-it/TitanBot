 ...
 */
export function t(language = 'en', key, params = {}) {
 ...
 */
export function getCategory(language = 'en', category) {
  return translations[language]?.[category] || translations.en[category];
}
